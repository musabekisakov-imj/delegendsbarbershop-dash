...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'analytics', element: page(AnalyticsPage, 'analytics.view') },
      { path: 'calendar', element: page(CalendarPage) },
      { path: 'bookings', element: page(BookingsPage) },
      { path: 'bookings/new', element: page(NewBookingPage, 'bookings.create') },
      { path: 'clients', element: page(ClientsPage, 'clients.view') },
