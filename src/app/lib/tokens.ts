...
export const STAFF_COLORS = [
  { bg: 'bg-card', border: 'border-l-blue-600 dark:border-l-blue-500',     text: 'text-foreground', sub: 'text-muted-foreground', dot: 'bg-blue-500',    light: 'bg-blue-100 dark:bg-blue-900/70',       label: 'text-blue-700 dark:text-blue-200',       ring: 'ring-blue-400',    surface: 'bg-blue-50 dark:bg-blue-950/30'    },
  { bg: 'bg-card', border: 'border-l-violet-600 dark:border-l-violet-500', text: 'text-foreground', sub: 'text-muted-foreground', dot: 'bg-violet-500',  light: 'bg-violet-100 dark:bg-violet-900/70',   label: 'text-violet-700 dark:text-violet-200',   ring: 'ring-violet-400',  surface: 'bg-violet-50 dark:bg-violet-950/30'  },
  { bg: 'bg-card', border: 'border-l-amber-600 dark:border-l-amber-500',   text: 'text-foreground', sub: 'text-muted-foreground', dot: 'bg-amber-500',   light: 'bg-amber-100 dark:bg-amber-900/70',     label: 'text-amber-700 dark:text-amber-200',     ring: 'ring-amber-400',   surface: 'bg-amber-50 dark:bg-amber-950/30'   },
  { bg: 'bg-card', border: 'border-l-green-600 dark:border-l-emerald-500', text: 'text-foreground', sub: 'text-muted-foreground', dot: 'bg-emerald-500', light: 'bg-emerald-100 dark:bg-emerald-900/70', label: 'text-emerald-700 dark:text-emerald-200', ring: 'ring-emerald-400', surface: 'bg-emerald-50 dark:bg-emerald-950/30' },
  { bg: 'bg-card', border: 'border-l-rose-600 dark:border-l-rose-500',     text: 'text-foreground', sub: 'text-muted-foreground', dot: 'bg-rose-500',    light: 'bg-rose-100 dark:bg-rose-900/70',       label: 'text-rose-700 dark:text-rose-200',       ring: 'ring-rose-400',    surface: 'bg-rose-50 dark:bg-rose-950/30'    },
  { bg: 'bg-card', border: 'border-l-cyan-600 dark:border-l-cyan-500',     text: 'text-foreground', sub: 'text-muted-foreground', dot: 'bg-cyan-500',    light: 'bg-cyan-100 dark:bg-cyan-900/70',       label: 'text-cyan-700 dark:text-cyan-200',       ring: 'ring-cyan-400',    surface: 'bg-cyan-50 dark:bg-cyan-950/30'    },
  { bg: 'bg-card', border: 'border-l-orange-600 dark:border-l-orange-500', text: 'text-foreground', sub: 'text-muted-foreground', dot: 'bg-orange-500',  light: 'bg-orange-100 dark:bg-orange-900/70',   label: 'text-orange-700 dark:text-orange-200',   ring: 'ring-orange-400',  surface: 'bg-orange-50 dark:bg-orange-950/30'  },
] as const;
